...
namespace Senshost.Controls.BadgeView
{
    ...
    public class BadgeView : BaseTemplatedView<Grid>
    {
        ...
        public static new BindableProperty BackgroundColorProperty =
            BindableProperty.Create(nameof(BackgroundColor), typeof(Color), typeof(BadgeView), defaultValue: Colors.Black,
                propertyChanged: OnLayoutPropertyChanged);
        ...
        public static readonly BindableProperty BorderColorProperty =
            BindableProperty.Create(nameof(BorderColor), typeof(Color), typeof(BadgeView), Colors.Black,
                propertyChanged: OnLayoutPropertyChanged);
        ...
        public static BindableProperty TextColorProperty =
            BindableProperty.Create(nameof(TextColor), typeof(Color), typeof(BadgeView), defaultValue: Colors.Black,
                propertyChanged: OnLayoutPropertyChanged);
