...
namespace Senshost_APP.Constants
{
    public static class APIConstants
    {
        ...
        public static string GetNotifications(string accountId, string userId,
            ...
            int? pageSize, int? pageNumber, string sortOrder) =>
                    $"api/notification/account/{accountId}?userId={userId}&severityLevel={severityLevel}&notificationStatus={notificationStatus}" +
                    $"&PageSize={pageSize}&PageNumber={pageNumber}&Sort={sortOrder}";
